...
if (isset($_POST['eliminar'])) {
    ...
    $idCurso = intval($_POST['eliminar']);
    $stmt = $pdo->prepare("DELETE FROM cursos WHERE idCurso = :idCurso");
    ...
    if ($stmt->execute()) {
        ...
        header("Location: cursos.php?error=eliminacion_fallida");
        exit();
    }
}

// Obtener lista de cursos con nombre del profesor asignado
$stmt = $pdo->query("
